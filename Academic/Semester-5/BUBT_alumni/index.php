    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container">
                ...
                <img src="assets/img/BUBT-Logos.png" width="50" height="50" class="d-inline-block align-middle" alt="">  
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <?php if(isset($_SESSION['login_id'])): ?>
                           <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=donation">Donation</a></li>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 - <?php echo $_SESSION['system']['name'] ?> | <a href="https://www.bubt.edu.bd" target="_blank">BUBTIANS</a></div></div>
        </footer>
